...
class ViT(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> List[torch.Tensor]:
        ...
        for i, blk in enumerate(self.blocks):
            ...
            # Cache the layer-24 feature, whose zero-based index is 23.
            if i == 23:
                feat_24 = x
            ...
            if (i == self.full_attn_ids[-1]) or (
                ...
                if i == self.full_attn_ids[-1]:
                    # Residual fusion weights for the final and layer-24 features.
                    w_32 = 0.8
                    w_24 = 0.2
                    if feat_24 is not None:
                        x = w_32 * x + w_24 * feat_24
